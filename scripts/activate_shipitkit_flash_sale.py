...
def activate_flash_page(root: Path, apply: bool, changed: list[str]) -> None:
    ...
    replacements = [
        ...
        ('href="mailto:arthur.pierrey@gmail.com?subject=Ship%20It%20Kit%20flash%20sale%20reminder" data-ph-event="ship_it_kit_flash_cta_clicked" data-ph-location="flash_hero_notify">Remind me when it starts</a>', 'href="/go/ship-it-kit/checkout-flash-hero/" data-ph-event="ship_it_kit_flash_cta_clicked" data-ph-location="flash_hero_buy">Get instant repo access — €29</a>', "hero CTA"),
        ('href="mailto:arthur.pierrey@gmail.com?subject=Ship%20It%20Kit%20flash%20sale%20reminder" data-ph-event="ship_it_kit_flash_cta_clicked" data-ph-location="flash_bottom_notify">Remind me when it starts</a>', 'href="/go/ship-it-kit/checkout-flash-bottom/" data-ph-event="ship_it_kit_flash_cta_clicked" data-ph-location="flash_bottom_buy">Get instant repo access — €29</a>', "bottom CTA"),
