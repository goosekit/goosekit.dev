...
BANNER_HTML='<div style="background:linear-gradient(90deg,#ff4800,#ff4800);padding:10px 16px;text-align:center;font-family:system-ui,sans-serif;font-size:0.85rem;color:#fff;font-weight:600;"><span>🚨 Ship It Kit Launch — €49 ends April 30</span> <a href="/go/ship-it-kit/home-promo/?source=urgency_banner" style="color:#fff;text-decoration:underline;margin-left:8px;">See the offer →</a></div>'
