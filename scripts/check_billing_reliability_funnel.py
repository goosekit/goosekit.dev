...
PAGES = [
    ...
    },
    {
        ...
        "required": [
            ...
            "billing_reconciliation_builder_setup_followup_viewed",
            "billing_health_interest",
            "data-ph-product=\"billing_reliability\"",
            "data-ph-location=\"hero\"",
            "data-ph-location=\"reconciliation_builder_output\"",
            "reconciliation_builder_setup_request_sent_followup",
            "data-ph-request-context=\"billing_reconciliation_query\"",
            "data-ph-request-context=\"billing_health_support\"",
            "data-ph-price-eur=\"99-149\"",
            "data-ph-price-eur-monthly=\"29\"",
            "data-ph-source-ref",
            "data-ph-followup-from",
            "setup_request_sent_query",
            "followup_from",
    ...
    },
    {
        ...
        "required": [
            ...
            "billing_health_first_month_check",
            "First-month check packet",
            "billing_health_first_month_query",
    ...
    },
    {
        ...
        "required": [
            ...
            "data-sent-followup=\"build_reconciliation_query\"",
            "data-sent-followup=\"review_revenue_leak_audit\"",
            "data-sent-followup=\"review_monthly_support\"",
    ...
    },
    {
        ...
        "required": [
            ...
            "Pick a packet shape if you are not sure",
            "Saved query or mismatch row",
            "Paid but blocked",
            "Trial conversion drift",
            ...
            "First-month reconciliation-backed billing health check",
            "Saved SQL query or one mismatch row",
            "source === 'trial_access_monthly_support'",
            "Monthly trial conversion access drift check",
            "Stripe subscription or invoice id around trial end",
            "source === 'setup_mode_card_monthly_support'",
            "Monthly setup-mode card gate check",
            "A saved card or SetupIntent should not unlock subscription-only access",
            "SetupIntent or Checkout Session id, local card-gate row",
    ...
    },
    {
        ...
        "required": [
            ...
            "/billing-reconciliation-query-builder/?ref=billing_health_sent_query",
            "/stripe-supabase-revenue-leak-audit/?ref=billing_health_sent_audit",
            "one Stripe object, one Supabase row or table, and one mismatch",
            "billing_health_request_sent_route",
            "price_eur_monthly: 29",
            "params.get('source_ref') || params.get('source')",
        ],
    },
    {
    ...
    },
    {
        ...
        "required": [
            "billing_drift_check_clicked",
            "trial_top",
            "trial_access_nav_packet",
            "trial_access_top_packet",
            "trial_access_bottom_packet",
            "&amp;context=trial_access",
            "&amp;quote_path=launch_blocker",
            "billing_health_interest",
            "trial_access_monthly_support_top",
            "trial_access_monthly_support_block",
            "trial_access_monthly_support_bottom",
            "trial_access_monthly_query",
            "Monthly trial conversion drift check",
    ...
    },
    {
        ...
        "required": [
            ...
            "billing_reconciliation_builder_started",
            "charged_stranded_query_block",
            "/billing-reconciliation-query-builder/?ref=charged_stranded_query_block",
            "billing_health_interest",
            "charged_stranded_monthly_support_top",
            "charged_stranded_query_monthly_support",
            "charged_stranded_monthly_support_block",
            "Monthly paid-but-blocked drift check",
            ...
            "/go/billing-reliability/health-support/?source=charged_stranded_monthly_support&track=access_drift&source_ref=charged_stranded_bottom",
    ...
    },
    {
        ...
        "required": [
            ...
            "setup_mode_card_gate_monthly_support",
            "setup_mode_card_monthly_query",
            "setup_mode_card_gate_bottom_packet",
            "context=setup_mode_card_gate",
            "/billing-reconciliation-query-builder/?ref=setup_mode_card_monthly_query",
            "/go/billing-reliability/health-support/?source=setup_mode_card_monthly_support&track=access_drift",
