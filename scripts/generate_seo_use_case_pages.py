...
PAGES = [
    ...
    {
        "slug": "api-request-header-debugging",
        "title": "API Request Header Debugging Workflow",
        "description": "Debug API request headers with JWT decoding, Base64 inspection, URL encoding checks, cURL conversion, and HTTP status lookup. A practical browser workflow for auth and webhook bugs.",
        "h1": "API request header debugging workflow",
        "eyebrow": "API debugging",
        "problem": "Broken API calls often come down to one header: a stale bearer token, a missing content type, a copied Basic Auth value, a malformed signature header, or an encoded callback URL hidden inside the request.",
        "primary_tool": {"name": "Start with the JWT Decoder", "url": "/jwt/"},
        "tools": [("JWT Decoder", "/jwt/"), ("Base64 Encoder/Decoder", "/base64/"), ("cURL Converter", "/curl-converter/"), ("URL Encoder", "/url-encode/"), ("HTTP Status Reference", "/http-status/"), ("JSON Formatter", "/json/")],
