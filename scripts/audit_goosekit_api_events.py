...
REQUIRED = {
    "api/index.html": [
        ...
        "reply email, endpoint needed",
        "seven required fields",
        "Reply email:",
        "Paid expectation:",
        "reply email, endpoint needs",
        "with reply email, endpoint, volume",
    ...
    "api/production-request/index.html": [
        ...
        "production_request_volume_examples",
        "production_request_runtime_examples",
        "production_request_specifics_examples",
        ...
        "Safety boundary",
        "Output/format",
        "data-specifics-example",
        "specificsExamplesMap",
        ...
        "support boundary",
        "reply email and a real request",
...
def main() -> None:
    ...
    for needle in (
        ...
        "goosekit_api_budget_example_clicked",
        "goosekit_api_failure_example_clicked",
        "completed_with_reply_email",
        "completed_missing_reply_email",
        "packet_copies_complete_with_reply_email",
        "complete_mail_clicks_with_reply_email",
        "complete_mail_clicks_missing_reply_email",
        "inspect_reply_email_friction",
        ...
        "Volume Example Choices",
        "runtime_example_choices",
        "Runtime Example Choices",
        "specifics_example_choices",
        "Specifics Example Choices",
        ...
        [
            ...
            },
            {
                ...
                "properties": {
                    ...
                    "ref": "json_endpoint_production",
                    "source_ref": "json_endpoint_production",
                    "missing_required_fields": "reply_email,volume,runtime,specifics,commercial,failure",
                    "required_fields_filled": "1",
                    "required_fields_total": "7",
    ...
    run_summary_fixture(
        "volume example click is observation only",
        [
            {
                "event": "goosekit_api_production_request_builder_viewed",
                "timestamp": "2026-06-19T08:18:00Z",
                "properties": {
                    "product": "goosekit_api",
                    "location": "production_request_builder",
                    "endpoint": "JSON formatter",
            ...
            {
                "event": "goosekit_api_volume_example_clicked",
                "timestamp": "2026-06-19T08:19:00Z",
                "properties": {
                    "product": "goosekit_api",
                    "location": "production_request_volume_examples",
                    "endpoint": "JSON formatter",
                    "ref": "json_endpoint_production",
                    "source_ref": "json_endpoint_production",
                    "example_label": "500k/month",
                    "example_value": "Around 500k requests/month for a real internal workflow.",
                    "missing_required_fields": "runtime,specifics,commercial,budget,failure",
                },
            },
            {
                "event": "goosekit_api_production_request_started",
        ...
        "inspect_builder_completion_friction",
        expected_counts={
            "volume_example_clicks": 1,
            "volume_example_choices.500k/month": 1,
            "first_fields.volume": 1,
            "start_sources.volume_example": 1,
            "missing_required_fields.runtime": 2,
        },
    )
    run_summary_fixture(
        "runtime example click is observation only",
        [
            {
                "event": "goosekit_api_production_request_builder_viewed",
                "timestamp": "2026-06-19T08:48:00Z",
                "properties": {
                    "product": "goosekit_api",
                    "location": "production_request_builder",
                    "endpoint": "JSON formatter",
            ...
            {
                "event": "goosekit_api_runtime_example_clicked",
                "timestamp": "2026-06-19T08:49:00Z",
                "properties": {
                    "product": "goosekit_api",
                    "location": "production_request_runtime_examples",
                    "endpoint": "JSON formatter",
                    "ref": "json_endpoint_production",
                    "source_ref": "json_endpoint_production",
                    "example_label": "Backend/CI job",
                    "example_value": "Backend job, worker script, CI job, or QA automation.",
                    "missing_required_fields": "volume,specifics,commercial,budget,failure",
                },
            },
            {
                "event": "goosekit_api_production_request_started",
        ...
        "inspect_builder_completion_friction",
        expected_counts={
            "runtime_example_clicks": 1,
            "runtime_example_choices.Backend/CI job": 1,
            "first_fields.runtime": 1,
            "start_sources.runtime_example": 1,
            "missing_required_fields.volume": 2,
        },
    )
    run_summary_fixture(
        "specifics example click is observation only",
        [
            {
                "event": "goosekit_api_production_request_builder_viewed",
                ...
                "properties": {
                    ...
                    "location": "production_request_builder",
                    "endpoint": "Hash generator",
                    "ref": "hash_endpoint_production",
                    "source_ref": "hash_endpoint_production",
                },
            },
            {
                "event": "goosekit_api_specifics_example_clicked",
                "timestamp": "2026-06-19T09:19:00Z",
                "properties": {
                    "product": "goosekit_api",
                    "location": "production_request_specifics_examples",
                    "endpoint": "Hash generator",
                    "ref": "hash_endpoint_production",
                    "source_ref": "hash_endpoint_production",
                    "example_label": "Safety boundary",
                    "example_value": "Inputs are safe non-secret values; do not send passwords, tokens, or private keys.",
                    "missing_required_fields": "volume,runtime,commercial,budget,failure",
                },
            },
            {
                "event": "goosekit_api_production_request_started",
                ...
                "properties": {
                    ...
                    "ref": "hash_endpoint_production",
                    "source_ref": "hash_endpoint_production",
                    "first_field": "specifics",
                    "start_source": "specifics_example",
                    "missing_required_fields": "volume,runtime,commercial,budget,failure",
                    "required_fields_filled": "1",
                    "required_fields_total": "6",
                },
        ...
        "inspect_builder_completion_friction",
        expected_counts={
            "specifics_example_clicks": 1,
            "specifics_example_choices.Safety boundary": 1,
        ...
        [
            ...
            },
            {
                ...
                "properties": {
                    ...
                    "ref": "json_endpoint_production",
                    "source_ref": "json_endpoint_production",
                    "missing_required_fields": "reply_email,volume,runtime,specifics,commercial,budget",
                    "required_fields_filled": "1",
                    "required_fields_total": "7",
    ...
    run_summary_fixture(
        ...
        [
            {
                ...
                "properties": {
                    ...
                    "source_ref": "json_endpoint_production",
                    "complete": "false",
                    "missing_required_fields": "reply_email,budget,failure",
            ...
            },
            {
                ...
                "properties": {
                    ...
                    "source_ref": "json_endpoint_production",
                    "complete": "false",
                    "missing_required_fields": "reply_email,failure",
        ...
        expected_counts={
            ...
            "missing_required_fields.reply_email": 2,
            "missing_required_fields.budget": 1,
            "missing_required_fields.failure": 2,
        },
    )
    run_summary_fixture(
        "completed packet without reply email inspects friction",
        [
            {
                "event": "goosekit_api_production_request_completed",
                "timestamp": "2026-06-18T18:20:00Z",
        ...
        "inspect_reply_email_friction",
        expected_counts={
            "completed_missing_reply_email": 1,
            "complete_mail_clicks_missing_reply_email": 1,
        },
    )
    run_summary_fixture(
        "completed packet with reply email requires mailbox check",
        [
            {
                "event": "goosekit_api_production_request_completed",
                "timestamp": "2026-06-18T18:20:00Z",
        ...
        "check_mailbox_before_lead",
        expected_counts={
            "completed_with_reply_email": 1,
            "complete_mail_clicks_with_reply_email": 1,
        },
    )
    run_summary_fixture(
