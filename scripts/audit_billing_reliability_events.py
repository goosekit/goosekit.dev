...
REQUIRED_EVENTS = [
    ...
    RequiredEvent("/blog/stripe-one-time-booking-subscription-credit-atomic/", "setup_help_request_clicked", "one_time_booking_bottom_mailto", require_product=True),
    ...
    RequiredEvent("/blog/stripe-payment-element-redirect-webhook-order-tracking/", "setup_help_request_clicked", "payment_element_order_tracking_bottom_mailto", require_product=True),
