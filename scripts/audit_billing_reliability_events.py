...
REQUIRED_EVENTS = [
    ...
    RequiredEvent("/stripe-supabase-revenue-leak-audit/", "billing_health_interest", "revenue_leak_audit_bottom", require_product=True),
    ...
    RequiredEvent("/blog/stripe-dunning-past-due-unpaid-supabase-access/", "dunning_access_incident_clicked", "dunning_top", require_product=True),
    ...
    RequiredEvent("/stripe-past-due-unpaid-supabase-access/", "setup_help_request_clicked", "dunning_access_hero", require_product=True),
    RequiredEvent("/stripe-past-due-unpaid-supabase-access/", "billing_health_interest", "dunning_access_hero", require_product=True),
    RequiredEvent("/stripe-past-due-unpaid-supabase-access/", "revenue_leak_audit_interest", "dunning_access_hero", require_product=True),
    RequiredEvent("/stripe-past-due-unpaid-supabase-access/", "billing_health_interest", "dunning_access_monthly_block", require_product=True),
    RequiredEvent("/stripe-past-due-unpaid-supabase-access/", "billing_reconciliation_builder_started", "dunning_access_monthly_block", require_product=True),
    RequiredEvent("/stripe-past-due-unpaid-supabase-access/", "setup_help_secondary_clicked", "dunning_access_monthly_block", require_product=True),
    RequiredEvent("/blog/stripe-customer-portal-cancel-supabase-status/", "billing_drift_check_clicked", "portal_cancel_top"),
    RequiredEvent("/blog/stripe-customer-portal-cancel-supabase-status/", "portal_cancel_incident_clicked", "portal_cancel_top", require_product=True),
    ...
    RequiredEvent("/blog/stripe-subscription-monthly-credits-double-grant-supabase/", "renewal_credit_incident_clicked", "monthly_credit_grant_top", require_product=True),
    ...
    RequiredEvent("/stripe-renewed-but-credits-not-added-supabase/", "billing_health_interest", "renewal_credit_hero", require_product=True),
    RequiredEvent("/stripe-renewed-but-credits-not-added-supabase/", "setup_help_request_clicked", "renewal_credit_hero", require_product=True),
    RequiredEvent("/stripe-renewed-but-credits-not-added-supabase/", "billing_reconciliation_builder_started", "renewal_credit_hero", require_product=True),
    RequiredEvent("/stripe-renewed-but-credits-not-added-supabase/", "billing_health_interest", "renewal_credit_monthly_block", require_product=True),
    RequiredEvent("/stripe-renewed-but-credits-not-added-supabase/", "setup_help_secondary_clicked", "renewal_credit_monthly_block", require_product=True),
    RequiredEvent("/stripe-renewed-but-credits-not-added-supabase/", "paid_access_incident_clicked", "renewal_credit_monthly_block", require_product=True),
    ...
    RequiredEvent("/blog/stripe-customer-portal-plan-change-supabase-entitlements/", "portal_plan_change_incident_clicked", "portal_plan_change_top", require_product=True),
    RequiredEvent("/stripe-customer-portal-plan-change-supabase-access/", "setup_help_request_clicked", "portal_plan_change_hero", require_product=True),
    RequiredEvent("/stripe-customer-portal-plan-change-supabase-access/", "billing_health_interest", "portal_plan_change_hero", require_product=True),
    RequiredEvent("/stripe-customer-portal-plan-change-supabase-access/", "revenue_leak_audit_interest", "portal_plan_change_hero", require_product=True),
    RequiredEvent("/stripe-customer-portal-plan-change-supabase-access/", "billing_health_interest", "portal_plan_change_monthly_block", require_product=True),
    RequiredEvent("/stripe-customer-portal-plan-change-supabase-access/", "billing_reconciliation_builder_started", "portal_plan_change_monthly_block", require_product=True),
    RequiredEvent("/stripe-customer-portal-plan-change-supabase-access/", "setup_help_secondary_clicked", "portal_plan_change_monthly_block", require_product=True),
    RequiredEvent("/stripe-customer-portal-cancel-supabase-access/", "setup_help_request_clicked", "portal_cancel_hero", require_product=True),
    RequiredEvent("/stripe-customer-portal-cancel-supabase-access/", "billing_health_interest", "portal_cancel_hero", require_product=True),
    RequiredEvent("/stripe-customer-portal-cancel-supabase-access/", "revenue_leak_audit_interest", "portal_cancel_hero", require_product=True),
    RequiredEvent("/stripe-customer-portal-cancel-supabase-access/", "billing_health_interest", "portal_cancel_monthly_block", require_product=True),
    RequiredEvent("/stripe-customer-portal-cancel-supabase-access/", "billing_reconciliation_builder_started", "portal_cancel_monthly_block", require_product=True),
    RequiredEvent("/stripe-customer-portal-cancel-supabase-access/", "setup_help_secondary_clicked", "portal_cancel_monthly_block", require_product=True),
]
...
REQUIRED_LINKS = [
    ...
    RequiredLink(
        "/go/billing-reliability/health-support/",
        "source === 'renewal_credit_monthly_support'",
        "billing-health route renewal-credit monthly prefill",
    ),
    RequiredLink(
        "/go/billing-reliability/health-support/",
        "source === 'portal_plan_change_monthly_support'",
        "billing-health route portal-plan monthly prefill",
    ),
    RequiredLink(
        "/go/billing-reliability/health-support/",
    ...
    RequiredLink(
        "/blog/stripe-subscription-monthly-credits-double-grant-supabase/",
        "/stripe-renewed-but-credits-not-added-supabase/?ref=monthly_credit_grant_top",
        "monthly credit article to renewal-credit root CTA",
    ),
    RequiredLink(
        "/stripe-renewed-but-credits-not-added-supabase/",
        "/go/billing-reliability/health-support/?source=renewal_credit_monthly_support&track=access_drift&source_ref=renewal_credit_hero",
        "renewal-credit hero monthly support route",
    ),
    RequiredLink(
        "/stripe-renewed-but-credits-not-added-supabase/",
        "/go/billing-reliability/setup-request/?source=renewal_credit_incident&context=renewal_credit_grant",
        "renewal-credit incident setup-request route",
    ),
    RequiredLink(
        "/stripe-renewed-but-credits-not-added-supabase/",
        "/go/billing-reliability/health-support/?source=renewal_credit_monthly_support&track=access_drift&source_ref=renewal_credit_monthly_block",
        "renewal-credit monthly block support route",
    ),
    RequiredLink(
        "/billing-health-support/",
        "/stripe-renewed-but-credits-not-added-supabase/?ref=billing_health_review_tracks",
        "billing-health links to renewal-credit root",
    ),
    RequiredLink(
        "/billing-health-support/",
        "/stripe-customer-portal-plan-change-supabase-access/?ref=billing_health_review_tracks",
        "billing-health links to portal-plan root",
    ),
    RequiredLink(
        "/billing-health-support/",
        "/stripe-customer-portal-cancel-supabase-access/?ref=billing_health_review_tracks",
        "billing-health links to portal-cancel root",
    ),
    RequiredLink(
        "/billing-health-support/",
        "/stripe-past-due-unpaid-supabase-access/?ref=billing_health_review_tracks",
        "billing-health links to dunning-access root",
    ),
    RequiredLink(
        "/blog/stripe-dunning-past-due-unpaid-supabase-access/",
        "/stripe-past-due-unpaid-supabase-access/?ref=dunning_top",
        "dunning article to commercial root CTA",
    ),
    RequiredLink(
        "/stripe-past-due-unpaid-supabase-access/",
        "/go/billing-reliability/setup-request/?source=dunning_access_incident&context=dunning_access",
        "dunning-access incident setup-request route",
    ),
    RequiredLink(
        "/stripe-past-due-unpaid-supabase-access/",
        "/go/billing-reliability/health-support/?source=dunning_access_monthly_support&track=access_drift&source_ref=dunning_access_hero",
        "dunning-access hero monthly support route",
    ),
    RequiredLink(
        "/stripe-past-due-unpaid-supabase-access/",
        "/go/billing-reliability/health-support/?source=dunning_access_monthly_support&track=access_drift&source_ref=dunning_access_monthly_block",
        "dunning-access monthly block support route",
    ),
    RequiredLink(
        "/go/billing-reliability/health-support/",
        "source === 'dunning_access_monthly_support'",
        "dunning-access monthly support route prefill",
    ),
    RequiredLink(
        "/blog/stripe-customer-portal-plan-change-supabase-entitlements/",
        "/stripe-customer-portal-plan-change-supabase-access/?ref=portal_plan_change_top",
        "portal plan article to commercial root CTA",
    ),
    RequiredLink(
        "/blog/stripe-customer-portal-cancel-supabase-status/",
        "/stripe-customer-portal-cancel-supabase-access/?ref=portal_cancel_top",
        "portal cancel article to commercial root CTA",
    ),
    RequiredLink(
        "/stripe-customer-portal-plan-change-supabase-access/",
        "/go/billing-reliability/setup-request/?source=portal_plan_change_incident&context=portal_plan_change",
        "portal-plan incident setup-request route",
    ),
    RequiredLink(
        "/stripe-customer-portal-plan-change-supabase-access/",
        "/go/billing-reliability/health-support/?source=portal_plan_change_monthly_support&track=access_drift&source_ref=portal_plan_change_hero",
        "portal-plan hero monthly support route",
    ),
    RequiredLink(
        "/stripe-customer-portal-plan-change-supabase-access/",
        "/go/billing-reliability/health-support/?source=portal_plan_change_monthly_support&track=access_drift&source_ref=portal_plan_change_monthly_block",
        "portal-plan monthly block support route",
    ),
    RequiredLink(
        "/stripe-customer-portal-cancel-supabase-access/",
        "/go/billing-reliability/setup-request/?source=portal_cancel_incident&context=portal_cancel",
        "portal-cancel incident setup-request route",
    ),
    RequiredLink(
        "/stripe-customer-portal-cancel-supabase-access/",
        "/go/billing-reliability/health-support/?source=portal_cancel_monthly_support&track=access_drift&source_ref=portal_cancel_hero",
        "portal-cancel hero monthly support route",
    ),
    RequiredLink(
        "/stripe-customer-portal-cancel-supabase-access/",
        "/go/billing-reliability/health-support/?source=portal_cancel_monthly_support&track=access_drift&source_ref=portal_cancel_monthly_block",
        "portal-cancel monthly block support route",
    ),
    RequiredLink(
        "/go/billing-reliability/health-support/",
        "source === 'portal_cancel_monthly_support'",
        "portal-cancel monthly support route prefill",
    ),
    RequiredLink(
