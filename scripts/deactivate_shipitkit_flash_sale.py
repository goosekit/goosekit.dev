...
def deactivate_flash_page(root: Path, apply: bool, changed: list[str]) -> None:
    ...
    replacements = [
        ...
        ('href="/ship-it-kit-quick-fit/?ref=flash_pending_hero" data-ph-event="ship_it_kit_flash_cta_clicked" data-ph-location="flash_hero_quick_fit">Take the 30-sec fit check</a>', 'href="/go/ship-it-kit/product-from-flash/" data-ph-event="ship_it_kit_flash_secondary_click" data-ph-location="flash_hero_product_after_sale">See current product page</a>'),
        ...
        ('href="/ship-it-kit-quick-fit/?ref=flash_pending_bottom" data-ph-event="ship_it_kit_flash_cta_clicked" data-ph-location="flash_bottom_quick_fit">Take the 30-sec fit check</a>', 'href="/go/ship-it-kit/product-from-flash/" data-ph-event="ship_it_kit_flash_secondary_click" data-ph-location="flash_bottom_product_after_sale">See current product page</a>'),
        ...
        ('<a class="btn btn-secondary" href="/ship-it-kit/?ref=flash_pending_hero_secondary#proof" data-ph-event="ship_it_kit_flash_cta_clicked" data-ph-location="flash_hero_product_proof">See exact product proof</a>', ''),
        ...
        ('<a class="btn btn-secondary" href="/ship-it-kit/?ref=flash_pending_bottom_secondary#proof" data-ph-event="ship_it_kit_flash_cta_clicked" data-ph-location="flash_bottom_product_proof">See exact product proof</a>', ''),
        ('href="mailto:arthur.pierrey@gmail.com?subject=Ship%20It%20Kit%20flash%20sale%20reminder" data-ph-event="ship_it_kit_flash_cta_clicked" data-ph-location="flash_bottom_notify">Remind me when it starts</a>', 'href="/go/ship-it-kit/product-from-flash/" data-ph-event="ship_it_kit_flash_secondary_click" data-ph-location="flash_bottom_product_after_sale">See current product page</a>'),
