...
def deactivate_flash_page(root: Path, apply: bool, changed: list[str]) -> None:
    ...
    replacements = [
        ...
        ("Ship It Kit flash sale starts April 28 — €29 until April 30, then back to €49", "Ship It Kit flash sale ended — Ship It Kit is back to €49", "topbar preview"),
        ...
        ('<div class="badge">Price Switch Pending</div>', '<div class="badge">Sale Ended</div>', "badge pending"),
        ...
        ('The sale window is open, but checkout stays closed until Lemon Squeezy shows €29. Use the product page to check fit honestly first.', 'The flash sale has ended. The regular Ship It Kit product page is the current source of truth.'),
        ...
        ('Checkout opens after price verification', 'Sale ended'),
        ...
        ('href="/go/ship-it-kit/notify-flash/" data-ph-event="ship_it_kit_flash_cta_clicked" data-ph-location="flash_hero_notify">Remind me when it starts</a>', 'href="/go/ship-it-kit/product-from-flash/" data-ph-event="ship_it_kit_flash_secondary_click" data-ph-location="flash_hero_product_after_sale">See current product page</a>'),
        ('href="/ship-it-kit/?ref=flash_pending_hero" data-ph-event="ship_it_kit_flash_cta_clicked" data-ph-location="flash_hero_fit_check">Check stack fit first</a>', 'href="/go/ship-it-kit/product-from-flash/" data-ph-event="ship_it_kit_flash_secondary_click" data-ph-location="flash_hero_product_after_sale">See current product page</a>'),
        ...
        ('href="/go/ship-it-kit/notify-flash/" data-ph-event="ship_it_kit_flash_cta_clicked" data-ph-location="flash_bottom_notify">Remind me when it starts</a>', 'href="/go/ship-it-kit/product-from-flash/" data-ph-event="ship_it_kit_flash_secondary_click" data-ph-location="flash_bottom_product_after_sale">See current product page</a>'),
        ('href="/ship-it-kit/?ref=flash_pending_bottom" data-ph-event="ship_it_kit_flash_cta_clicked" data-ph-location="flash_bottom_fit_check">Check stack fit first</a>', 'href="/go/ship-it-kit/product-from-flash/" data-ph-event="ship_it_kit_flash_secondary_click" data-ph-location="flash_bottom_product_after_sale">See current product page</a>'),
        ('<a class="btn btn-secondary" href="/ship-it-kit-flash-sale.ics" data-ph-event="ship_it_kit_flash_calendar_clicked" data-ph-location="flash_hero_calendar">Add sale to calendar</a>', ''),
        ('<a class="btn btn-secondary" href="/ship-it-kit/#pricing" data-ph-event="ship_it_kit_flash_cta_clicked" data-ph-location="flash_hero_pricing_check">See current product page</a>', ''),
        ('<a class="btn btn-secondary" href="/ship-it-kit-flash-sale.ics" data-ph-event="ship_it_kit_flash_calendar_clicked" data-ph-location="flash_bottom_calendar">Add sale to calendar</a>', ''),
        ('<a class="btn btn-secondary" href="/ship-it-kit/#pricing" data-ph-event="ship_it_kit_flash_cta_clicked" data-ph-location="flash_bottom_pricing_check">See current product page</a>', ''),
        ('href="mailto:arthur.pierrey@gmail.com?subject=Ship%20It%20Kit%20flash%20sale%20reminder" data-ph-event="ship_it_kit_flash_cta_clicked" data-ph-location="flash_bottom_notify">Remind me when it starts</a>', 'href="/go/ship-it-kit/product-from-flash/" data-ph-event="ship_it_kit_flash_secondary_click" data-ph-location="flash_bottom_product_after_sale">See current product page</a>'),
        ...
        ('<h3 style="margin:0 0 8px;color:#fff;">Is the €29 checkout open?</h3>\n        <p style="margin:0 0 18px;color:#cbd5e1;">Not yet. The sale window is open, but checkout stays closed until the Lemon Squeezy price is verified at €29.</p>', '<h3 style="margin:0 0 8px;color:#fff;">What happened after April 30?</h3>\n        <p style="margin:0 0 18px;color:#cbd5e1;">The flash sale ended and the product returned to the regular €49 price.</p>'),
        ...
        ('The sale window is open. Checkout appears here after price verification; check the stack fit first.', 'The sale has ended. Check the current product page first; buy only if it matches your project.'),
        ...
        ('€29 window is queued until April 30. If the stack does not match, skip it honestly.', 'Flash sale ended. If the stack does not match, skip it honestly.'),
...
def deactivate_product_page(root: Path, apply: bool, changed: list[str]) -> None:
    ...
    replacements = [
        ...
        ('<a class="launch-banner-link" href="/ship-it-kit-flash/?ref=product_launch_banner" data-ph-event="ship_it_kit_secondary_click" data-ph-location="launch_banner_flash_preview">Flash sale starts April 28 — €29 until April 30. Check fit before buying.</a>', '<a class="launch-banner-link" href="/ship-it-kit/?ref=post_flash_launch_banner#proof" data-ph-event="ship_it_kit_secondary_click" data-ph-location="launch_banner_post_flash">Flash sale ended — Ship It Kit is back to €49. Check stack fit before buying.</a>'),
        ('<a class="launch-banner-link" href="/ship-it-kit-flash/?ref=product_launch_banner" data-ph-event="ship_it_kit_secondary_click" data-ph-location="launch_banner_flash_preview">€29 sale window is queued until April 30. Checkout opens after price verification — check fit first.</a>', '<a class="launch-banner-link" href="/ship-it-kit/?ref=post_flash_launch_banner#proof" data-ph-event="ship_it_kit_secondary_click" data-ph-location="launch_banner_post_flash">Flash sale ended — Ship It Kit is back to €49. Check stack fit before buying.</a>'),
...
def deactivate_weekend_page(root: Path, apply: bool, changed: list[str]) -> None:
    ...
    replacements = [
        ...
        ('🚨 Flash sale starts April 28 — Ship It Kit will be €29 until April 30', '🚨 Ship It Kit Launch — €49 ended April 30'),
        ('🚨 Ship It Kit €29 sale window is queued until April 30 — checkout opens after price verification', '🚨 Ship It Kit Launch — €49 ended April 30'),
        ...
        ('Check stack fit first →', 'See the exact files first →'),
